...
class Styles {
  static Color appPrimaryColorDark = Colors.grey[850] as Color; //Color(0xFF00022E);
  static Color appPrimaryColor = Colors.grey[700] as Color;
  // Color(0xFF00068A); //Color.fromRGBO(155, 81, 224, 1);
  static Color appAccentColor = Colors.cyan[600] as Color;
  static Color appCanvasColor = Colors.white;
  static Color appBackground = Colors.blue;
  static Color commonDarkBackground = Colors.grey[200] as Color;
  static Color commonDarkCardBackground = Colors.grey[200] as Color; // #1e2d3b
  ...
  static Color appDrawerIconColor = Colors.grey[800] as Color;
  ...
  static Color vipCardBgColor = Colors.orange[100] as Color;
